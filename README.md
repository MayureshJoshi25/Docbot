...
This project is licensed under the MIT License - see the LICENSE file for details. (Note: A LICENSE file will need to be added separately if not already present.)
